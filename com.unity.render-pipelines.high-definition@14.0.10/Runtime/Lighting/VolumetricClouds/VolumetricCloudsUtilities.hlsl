                            ...
                            out CloudProperties properties)
{
    ...
    float3 baseNoiseSamplingCoordinates = float3(AnimateBaseNoisePosition(positionPS).xzy / NOISE_TEXTURE_NORMALIZATION_FACTOR) * _ShapeScale - float3(0, 0, _VerticalShapeNoiseOffset);
